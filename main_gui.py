...
training_dataset = pd.read_csv("D:\HealthcareChatbot\data\Training.csv")
test_dataset = pd.read_csv("D:\HealthcareChatbot\data\Testing.csv")
...
doc_dataset = pd.read_csv("D:\HealthcareChatbot\data\doctors_dataset.csv", names = ['Name', 'Description'])
...
class MainForm(Frame):
    ...
    def createWidget(self):
        ...
        self.lblowner = Label(self, text="Made by:", bg="khaki", width="250", height="1", padx=10, pady=10,
                              font=("Helvetica", 13))
        self.lblowner.pack()

        self.lblAuthor = Label(self, text="Alebale Vaijanath", bg="white", width="250", height="1",
                               font=("Calibri", 13))
        self.lblAuthor.pack()
